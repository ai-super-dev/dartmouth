    ...
    <div className={`bg-white border-r border-gray-200 h-screen flex flex-col transition-all duration-300 ${
      ...
      {isCollapsed ? (
        ...
        <div className="flex flex-col items-center py-4 space-y-3">
          ...
          {/* Task Manager */}
          <button 
            onClick={() => { onToggle(); navigate('/task-manager'); setIsTaskManagerExpanded(true); }} 
            className={`p-2 rounded-lg transition-colors ${
              location.pathname.startsWith('/task-manager') || location.pathname === '/task-digest'
                ? 'bg-indigo-50 text-indigo-600'
                : 'text-gray-600 hover:bg-indigo-50 hover:text-indigo-600'
            }`} 
            title="Task Manager"
        ...
        <div className="overflow-y-auto flex-1 p-3">
          ...
          >
            ...
            <SubNavLink to="/memo">@Memos</SubNavLink>
            <SubNavLink to="/tags">Tags</SubNavLink>
          </CollapsibleSection>
          ...
          <CollapsibleSection
            ...
            isExpanded={isTaskManagerExpanded}
            onToggle={() => setIsTaskManagerExpanded(!isTaskManagerExpanded)}
          >
            <SubNavLink to="/task-manager">Dashboard</SubNavLink>
            <SubNavLink to="/task-manager/agent-status">Agent Status</SubNavLink>
            <SubNavLink to="/task-digest">Daily Digest</SubNavLink>
          </CollapsibleSection>
          ...
          >
            ...
            <SubNavLink to="/settings/task-manager">Task Manager</SubNavLink>
