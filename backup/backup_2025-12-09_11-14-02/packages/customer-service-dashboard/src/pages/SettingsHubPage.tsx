...
const settingsOptions: SettingsOption[] = [
  ...
  {
    title: 'Group Chat',
    description: 'Configure Group Chat channels, permissions, and edit/delete timeframes',
    path: '/settings/group-chat',
    category: 'Business',
  },
  // AI Agent
  {
  ...
  {
    title: 'Tags',
    description: 'Configure AI auto-tagging, tag suggestions, and display preferences',
    path: '/settings/tags',
    category: 'General',
  },
  // Billing
